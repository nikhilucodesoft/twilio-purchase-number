...
<head>
    ...
    <style>
        span.text-red-500.mt-1.block.text-sm {
            margin-left: 20px;
            color: red;
        }
...
<body>
    ...
    <script>
        $(document).ready(function() {
            @if (Session::has('sweet-error'))
                Swal.fire({
                    title: "",
                    text: "{{ Session::get('sweet-error') }}",
                    icon: "info",
                    imageHeight: 10,
                    customClass: {
            ...
            @elseif (Session::has('sweet-success'))
                Swal.fire({
                    title: "Success",
                    text: "{{ Session::get('sweet-success') }}",
                    customClass: {
                        title: 'text-base',
                        confirmButton: 'rounded-sm'
                    },
