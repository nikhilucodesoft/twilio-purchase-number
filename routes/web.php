...
Route::match(array('GET', 'POST'),'/phone_number_price', 'PricingController@phoneNumbers')->name('phone_number_price');
Route::get('/purchase_number/{number}/{country_code}','PricingController@purchase_number')->name('purchase_number');
Route::post('purchase_number','PricingController@postAddress')->name('purchase_number_form');
